...
plot \
    ...
    "Figure_1/combined_heisenberg_kagome_16.csv" \
        u 1:2 with linespoints ls 1 pt 7 ps 0.5 lw 2 title "Kagome 16", \
    "Figure_1/combined_heisenberg_kagome_16.csv" \
    ...
    "Figure_1/combined_heisenberg_kagome_18.csv" \
        u 1:2 with linespoints ls 2 pt 5 ps 0.5 lw 2 title "Kagome 18", \
    "Figure_1/combined_heisenberg_kagome_18.csv" \
    ...
    "Figure_1/combined_j1j2_square_4x4.csv" \
        u 1:2 w linespoints ls 3 pt 13 lw 2 ps 0.6 title "J_1-J_2", \
    "Figure_1/combined_j1j2_square_4x4.csv" \
    ...
    "Figure_1/combined_sk_16_1.csv" \
        u 1:2 with linespoints ls 4 pt 9 lw 2 ps 0.6 title "Random №1", \
    "Figure_1/combined_sk_16_1.csv" \
    ...
    "Figure_1/combined_sk_16_2.csv" \
        u 1:2 with linespoints ls 5 pt 9 lw 2 ps 0.6 title "Random №2", \
    "Figure_1/combined_sk_16_2.csv" \
    ...
    "Figure_1/combined_sk_16_3.csv" \
        u 1:2 with linespoints ls 6 pt 9 lw 2 ps 0.6 title "Random №3", \
    "Figure_1/combined_sk_16_3.csv" \
